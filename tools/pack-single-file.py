...
OUT = Path("/mnt/user-data/outputs/install-alder-bend-stage3.yml")
...
{body}
      ...
      - name: Commit
        run: |
          ...
          git add -A
          git commit -m "Alder Bend Stage 3: broadcast blocks, manifest, tiered retention"
          git push
