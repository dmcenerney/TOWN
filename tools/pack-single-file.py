...
OUT = Path("/mnt/user-data/outputs/install-alder-bend-stage4.yml")
...
{body}
      ...
      - name: Commit
        run: |
          ...
          git add -A
          git commit -m "Alder Bend Stage 4: the observer — you can open the page and watch the town"
          git push
